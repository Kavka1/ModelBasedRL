...
from ModelBasedRL.env.dynamics_variance_wrap.Halfcheetah import HalfCheetah_Friction_Variance_Wrapper
...
def main(path: str, remark: str, num_models: int = 4, collect_action_num: int = 2000) -> None:
    ...
    env = HalfCheetah_Friction_Variance_Wrapper(
    ...
    for i, ax in enumerate(axs):
        ...
        ax.set_title(f'HalfCheetah - IDM Prediction Accuracy under various foot friction shifts', fontsize=12)
        ax.legend().set_title('')
